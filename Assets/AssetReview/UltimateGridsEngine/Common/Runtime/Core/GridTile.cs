...
public class GridTile : MonoBehaviour {
    ...
    [ReadOnly] public Vector2Int m_GridPosition = new Vector2Int(int.MaxValue, int.MaxValue);	// The position on the grid
    public int m_TileHeight = 0;		// Height of this tile
    [ReadOnly] public Vector3 m_WorldPosition;  // The Transforms scene position
    ...
    public virtual void Initialize(Vector3Int posInfo) {
        ...
        if (!GridManager.ExistsTileAtPosition(m_GridPosition)) {
            GridManager.AddGridTile(m_GridPosition, this);
    ...
    protected virtual void RemoveTile() {
        GridManager.RemoveGridTile(this);
    }
