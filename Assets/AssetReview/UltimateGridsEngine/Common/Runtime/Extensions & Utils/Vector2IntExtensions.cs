...
public static class Vector2IntExtensions {
    ...
    public static Vector3 ToVector3X0Z(this Vector2Int vec2) {
        return new Vector3((float)vec2.x, 0f, (float)vec2.y);
    }

    public static Vector3 ToVector3XY0(this Vector2Int vec2) {
        return new Vector3((float)vec2.x, (float)vec2.y, 0f);
    }
    ...
    public static int GridDistance(this Vector2Int fromVector, Vector2Int toVector) {
        return Mathf.RoundToInt((float)(Mathf.Abs(fromVector.x - toVector.x) + Mathf.Abs(fromVector.y - toVector.y)));
    }
}
